...
namespace Abc.Pages.Extensions 
{
    ...
    {
        public static IHtmlContent TableRowFor(this IHtmlHelper htmlHelper, 
            string page, object index, params IHtmlContent[] values)
        {
        ...
        private static List<object> htmlStrings(string page, object index, string fixedFilter,
            string fixedValue, IHtmlContent[] values)
        {
            var list = new List<object>();
            foreach (var value in values) addValue(list, value);
            list.Add(new HtmlString("<td>"));
        ...
        private static List<object> htmlStringsWithSelect(string page, object id, string sortOrder,
            string searchString, int pageIndex, string fixedFilter, string fixedValue, IHtmlContent[] values)
        {
            var list = new List<object>();
            foreach (var value in values) addValue(list, value);
            var s = $"?id={id}";
