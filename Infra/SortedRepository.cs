...
//class MeasuresRepository =>  private IQueryable<MeasureData> createSorted() => уменьшение кода
//case "ValidFrom":
...
namespace Abc.Infra
{
        ...
        where TDomain : Entity<TData>, new()
    {
        ...
        internal Expression<Func<TData, object>> lambdaExpression(PropertyInfo p) //(s => s.ValidFrom);
        {
